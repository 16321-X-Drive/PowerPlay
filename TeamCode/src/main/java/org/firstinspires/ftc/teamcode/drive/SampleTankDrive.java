...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardware.getLeftFront();
        DcMotorEx leftRear = hardware.getLeftBack();
        DcMotorEx rightRear = hardware.getRightBack();
        DcMotorEx rightFront = hardware.getRightFront();
