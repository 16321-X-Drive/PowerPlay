...
class RRLeftAuto : LinearOpModeEx() {
    ...
    class RRLeft : LinearOpMode() {
        override fun runOpMode() = RRLeftAuto().runOpMode(this)
    }
    ...
    private val region = Rect(140, 150, 30, 15)
    ...
    val STACK_UP = Pose2d(-57.0, HEIGHT + 2.0, towardWall)
    val STACK_MIDPOINT_UP = Pose2d(-45.0, HEIGHT + 2.0, towardWall)
